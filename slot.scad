...
module slot_hole(h=5, r=2.5, l=10, snap=false, snap_s=2, chamfered=false, tolerance=0, rot=180) {
  union() {
    hull() {
...
difference() {
  union() {
    *difference() {
      ...
      slot_hole(h=5, r=2.5, l=10, snap=true, snap_s=2, chamfered=false, tolerance=0.1);
    }

    slot_hole(h=5, r=2.5, l=10, snap=true, snap_s=2, chamfered=true, rot=170);
  }
